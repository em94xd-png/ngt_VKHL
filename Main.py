...
# Print
def print_Room_Discrepancy(file):
...
file_url_Room_Discrepancy = "file:///" + os.path.abspath(file_local_Room_Discrepancy).replace("\\", "/").__add__(".PDF") # Convert your local absolute file path into a file:// URL structure
