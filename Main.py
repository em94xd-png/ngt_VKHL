...
pyautogui.click(123,302, interval=.01)
pyautogui.click(123,520, interval=.01)
time.sleep(1)
pyautogui.hotkey("ctrl", "c", interval=.01)
pyautogui.press("tab", presses=2, interval=.01)
time.sleep(1)
pyautogui.hotkey("ctrl", "v", interval=.01)
pyautogui.press("tab", presses=53, interval=.01)
pyautogui.press("enter", interval=.01)
time.sleep(8.5)
...
time.sleep(1.5)
pyautogui.press("tab", presses=4, interval=.01)
pyautogui.press("down", presses=4, interval=.01) # Report position
pyautogui.press("enter", interval=.01)
pyautogui.press("left", interval=.01)
pyautogui.press("enter", interval=.01)
time.sleep(.5)
...
pyautogui.write("ooo", interval=.01)
pyautogui.press("enter", interval=.01)
time.sleep(2.5)
pyautogui.press("tab", presses=9, interval=.01)
pyautogui.press("down", presses=2, interval=.01)
